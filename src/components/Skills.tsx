const skillGroups = [
  {
    category: 'Frontend',
    color: 'teal',
    skills: ['React.js', 'React Native', 'JavaScript (ES6+)', 'HTML5', 'CSS3', 'Tailwind CSS', 'Responsive UI'],
  },
  {
    category: 'Backend',
    color: 'sky',
    skills: ['Django', 'Node.js (Basic)', 'REST API', 'Python', 'Axios / Fetch'],
  },
  {
    category: 'Database',
    color: 'emerald',
    skills: ['MySQL', 'MongoDB', 'Local Storage Mock Backend'],
  },
  {
    category: 'AI / ML',
    color: 'amber',
    skills: ['RAG Basics', 'Groq API', 'Llama Models', 'AI Chatbot Integration'],
  },
  {
    category: 'Mobile',
    color: 'rose',
    skills: ['React Native', 'Expo', 'EAS Build', 'APK / AAB Builds'],
  },
  {
    category: 'Tools & DevOps',
    color: 'slate',
    skills: ['Git & GitHub', 'GitHub Copilot', 'Postman', 'VS Code'],
  },
];
...
const colorMap: Record<string, { badge: string; dot: string; border: string; heading: string }> = {
  ...
  slate: {
    badge: 'bg-slate-600/30 text-slate-300 border-slate-600/40 hover:bg-slate-600/50',
    dot: 'bg-slate-400',
    ...
    <section id="skills" className="py-24 bg-slate-950">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          <p className="text-teal-400 text-sm font-semibold tracking-widest uppercase mb-3">Technical Skills</p>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-2.5 mb-5">
                  ...
                  <h3 className={`font-semibold text-sm tracking-wide uppercase ${c.heading}`}>{category}</h3>
                </div>
